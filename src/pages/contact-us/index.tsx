    ...
    <>
      ...
      >
        <Paper sx={{ padding: "2rem", width: "100%" }}>
          ...
          >
            راه‌های ارتباط با تیم پلتفرم کاموا
          </Typography>
          <Box
            sx={{
              display: "flex",
          ...
          >
            <Typography variant="subtitle1" marginBottom={"35px"}>
              پیام‌رسان‌ها
            </Typography>
            <Grid container width={"50%"}>
              <Grid item md={4} justifyContent={"center"} display={"flex"}>
                <a href="//rastaiha.ir">
                  <Image alt="" src={pic1} width={56} />
                </a>
              </Grid>
              <Grid item md={4} justifyContent={"center"} display={"flex"}>
                <a>
              ...
              <Grid item md={4} justifyContent={"center"} display={"flex"}>
                <a href="//t.me/rastaiha_info">
                  <Image alt="" src={pic2} width={56} />
                </a>
              </Grid>
            </Grid>
          </Box>
