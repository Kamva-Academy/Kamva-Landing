      ...
      >
        <Paper sx={{ padding: "2rem", width: "100%" }}>
          ...
          <Typography variant="subtitle1">
            کاموا بستری آنلاین جهت برگزاری رویدادها و کارگاه‌های تعاملی است که
            توسط جمع علمی-ترویجی رستا در دوران شیوع کرونا طراحی و پیاده‌سازی شده
            است.
          </Typography>
          <br />
          ...
          <Typography variant="subtitle1">
            ...
            شکل‌گیری جمعی را فراهم کردند که اکنون پس از حدود پنج سال از تشکیل
            آن، با نام «جمع علمی-ترویجی رستا» یا به اختصار «رستا» شناخته می‌شود.
            فعالیت رستا تاکنون در حوزه‌ی آموزش پرورشی علوم کامپیوتر و ریاضی برای
            دانش آموزان دوره‌‌های متوسطه اول و دوم بوده است.
          </Typography>
          <br />
          <Typography variant="subtitle1">
            گروه ما با هدف کلی رشد و ارتقای جهان‌بینی، فهم و همچنین پایه‌ ریزی
            زندگی بهتر و پویاتر برای دانش‌آموزان و دانشجویان کشور، نام «رستا» را
            که قریب به هدف پایانی بیان شده است و البته مبیّن خوبی برای کلیات
            اهداف و رویکرد گروه مذکور است، برای خود برگزید و با توجه به خاستگاه
            مذکور، در تابستان ۱۳۹۶ متشکل از دانشجویان رشته‌های علوم و مهندسی
            کامپیوتر، علوم ریاضی و فلسفه دانشگاه‌های برتر کشور نظیر صنعتی شریف،
            تهران، صنعتی اصفهان و ... تشکیل شد.
          </Typography>
          <br />
          <Typography variant="subtitle1">
            رستا هم‌اکنون داخل دانشگاه صنعتی شریف هم در قالب یک انجمن علمی با
            عنوان «انجمن علمی رستا» به ثبت رسیده است.
          </Typography>
          <br />
          ...
          <ul>
            ...
            <li>
              <Typography variant="subtitle1">
                اردوی زمستانه‌ی ریاضی‌ورزی، زمستان ٩٨، بوشهر، دانش‌آموزان دوره
                اول دبیرستان
              </Typography>
            </li>
            <li>
              <Typography variant="subtitle1">
                رویداد-مسابقه‌ی آنلاین کابارآمادالاپسته، نوروز ۹۹، دانش‌آموزان
                دوره دوم دبیرستان
              </Typography>
            </li>
            <li>
              <Typography variant="subtitle1">
                چهارمین مدرسه‌ی تابستانه‌ی رستا (رویداد آنلاین)، شهریور ۹۹،
                دانش‌آموزان دوره دوم دبیرستان
              </Typography>
            </li>
            <li>
              <Typography variant="subtitle1">
                رویداد آنلاین رستاخیز: مسافر صفر، نوروز ۱۴۰۰، دانش‌آموزان دوره
                دوم دبیرستان
              </Typography>
            </li>
            <li>
              <Typography variant="subtitle1">
                رویداد آنلاین مدرسه‌ی تابستانه ۱۴۰۰، ویژه‌ی دانش‌آموزان دوره‌ی
                دوم دبیرستان
              </Typography>
            </li>
            <li>
              <Typography variant="subtitle1">
                رویدادهای حضوری و مجازی مدرسه‌ی تابستانه ۱۴۰۱، با همکاری سازمان
                ملی پرورش استعدادهای درخشان و دانشگاه صنعتی شریف، ویژه‌ی
                دانش‌آموزان دوره‌ی دوم دبیرستان
              </Typography>
            </li>
            <li>
              <Typography variant="subtitle1">
          ...
          <Typography variant="subtitle1">
            برای ارتباط با گروه رستا جهت برگزاری رویداد یا جهت ارائه‌ی پیشنهادات
            و انتقادات، می‌توانید از راه‌های زیر با ما در ارتباط باشید:
          </Typography>
          <ul>
            <li>
              <Typography variant="subtitle1">
