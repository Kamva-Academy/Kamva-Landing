            ...
            <div style={{background:"#3498DB33" , width:"100%" , display:"flex" , flexDirection:"column" , alignItems:"center" , justifyContent:"center"}}>
                <Stack flexDirection={"column"} marginTop={"10rem"} width={"80%"} marginBottom={"10rem"}>
                    ...
                    <Grid md={6} xs={12}  sx={{width:"100%", display:"flex" , flexDirection:"column" , alignItems:"center" , justifyContent:"center"}}>
                        <Box sx={{ background:"#3C8CE791" , width:{lg:"46rem" , xs:"80%"}, borderRadius:"40px" , height:"33rem" , display:"flex" , alignItems:"center" , justifyContent:"space-between" , flexDirection:"column" , paddingTop:"1rem"}}>
                            <Typography  sx={{color:"#FFD358", fontSize:{md:"64px" , sm:"30px" , xs:"22px"} , fontWeight:"400" , fontFamily:"Lalezar"}}>برای دانش‌آموزان</Typography>
                            <Typography sx={{color:"rgba(0, 0, 0, 1)", fontSize:{lg:"36px" , md:"20px" , xs:"14px"} ,width:{lg:"40rem" , xs:"80%"}, fontWeight:"400" , fontFamily:"Lalezar" , textAlign:"center"}}>فقط فیلم ضبط‌شده نبین!  از یادگیریت بیشتر لذت ببر.</Typography>
