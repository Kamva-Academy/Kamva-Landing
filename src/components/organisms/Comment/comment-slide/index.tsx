...
const SliderCard = () => {
    return ( 
        <Box>
                <Box sx={{width:"22rem" , height:"35rem", borderRadius:"1.25rem" , border:"5px solid #00376F" , background:"#FFF"  ,display:"flex" , flexDirection:"column" , justifyContent:"center", alignItems:"center" , position:"relative"}}>
                    <Box sx={{width:"13.9375rem" , height:"13.375rem" , borderRadius:"13.9rem" , position:"absolute" , top:"-19%" , border:"5px solid #002256"}}></Box>
